...
Magnify.prototype = {
  ...
  wheel: function (e) {
    e.preventDefault();
    // console.log('deltaY - '+e.originalEvent.deltaY + 'wheelDelta - '+e.originalEvent.wheelDelta + 'wheelDelta - '+e.originalEvent.detail);
    ...
    $('.magnify-image').css('position', 'absolute');
    ...
    console.log('ratio - '+this.options.ratioThreshold);
    console.log('pointer - '+e.originalEvent.clientX);
  ...
  fullscreen: function () {
    // alert('full screen click');
    

    // $('.magnify-stage img').css({"min-height": '100%', "min-width": 'auto !important'});

    $('.magnify-stage img').addClass('myFullScreenImage');
  ...
  _keydown: function (e) {
    ...
    $('.magnify-stage img').removeClass('myFullScreenImage');
  ...
  _addEvents: function () {
    ...
    this.$next.off(CLICK_EVENT + EVENT_NS).on(CLICK_EVENT + EVENT_NS, function () {
      ...
      // console.log(JSON.stringify(self.jump(1)));
      // alert('test');
