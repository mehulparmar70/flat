...
<body class="hold-transition login-page" style="background-image: url('{{route("index")}}/adm/img/bg.jpg')">
<div class="login-box">
...
<!-- /.card -->
  <div class="col-sm-12 col-md-12 col-lg-12 mt-5 text-center">
    <img src="{{route('index')}}/sardar/img/{{getWebsiteOptions()['website_logo']['option_value']}}" alt="">
  </div>

  <div class="card card-outline card-danger login-form" style="background-image: url('{{route("index")}}/adm/img/login_window_bg.png');padding: 33px;">
    <div class="card-body">
  ...
  <div class="col-sm-12 col-md-12 col-lg-12 mt-5 text-center">
    ...
    <img src="{{route('index')}}/adm/img/login-footer.png" alt="">
