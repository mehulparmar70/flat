        ...
        <div class="card-body">
          ...
          <div class="col-md-12">
            ...
            <form enctype="multipart/form-data" method="post" class="form-horizontal" action="{{route('newsletter.store')}}">
              ...
              <div class="row">
                <div class="col-sm-4">
                  <label for="title">Add Newsletter Title</label>
                  <input type="text" class="form-control" name="title" placeholder="Newsletter Title" value="{{old('title')}}" required>
                  <span class="text-danger">@error('title') {{$message}} @enderror</span>
                </div>
                <div class="col-sm-4">
                  <label for="title">Add Newsletter Short Description</label>
                  <input type="text" class="form-control" name="short_description" placeholder="Newsletter Short Description" value="{{old('short_description')}}" required>     
                  <span class="text-danger">@error('short_description') {{$message}} @enderror</span>
                </div>
                <div class="col-sm-4">
                  <label for="title">Add Newsletter Page Url</label>
                  <input type="text" class="form-control" name="slug" placeholder="Url" value="{{old('slug')}}" required>     
                  <span class="text-danger">@error('slug') {{$message}} @enderror</span>
                </div>
                <div class="col-sm-12 mt-3">
                  <label for="full_description">Add Newsletter Description</label>
                  <textarea id="editor" name="full_description" placeholder="Newsletter Descriptions">{{old('full_description')}}</textarea>                  
              ...
              <div class="form-group row mt-3">
                <div class="col-sm-6 col-md-6">
                  <div class="col-sm-12">
                    <label for="image_alt">Add Newsletter Image</label><br>
                  ...
                  <div class="col-sm-12 row">
                    ...
                    <div class="col-sm-6">
                      ...
                      <input type="text" class="form-control" name="image_title" placeholder="Newsletter Image Title (SEO)" value="{{old('image_title')}}">
