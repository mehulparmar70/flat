                ...
                <div class="row">
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="name" placeholder="Title" value="@if(old('title')){{old('title')}}@else{{$testimonial->title}}@endif" required> 
                  ...
                  <div class="col-sm-3 col-md-2">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="image_alt" placeholder="Icon Alter Text (SEO)" value="@if(old('image_alt')){{old('image_alt')}}@else{{$testimonial->image_alt}}@endif">          
                  ...
                  <div class="col-sm-3 col-md-2">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="image_title" placeholder="Icon Title (SEO)" value="@if(old('image_title')){{old('image_title')}}@else{{$testimonial->image_title}}@endif">
                  ...
                  <div class="col-sm-12 row">
                    <div class="col-sm-4">
                      ...
                      <input type="text" class="form-control" name="page_link" placeholder="Link" value="@if(old('page_link')){{old('page_link')}}@else{{$testimonial->page_link}}@endif">    
