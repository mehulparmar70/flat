    ...
    <div class="row">
      ...
      <div class="col-sm-6">
            <ol class="breadcrumb ">
              ...
              <li class="breadcrumb-item active">Industries List</li>
            </ol>
          </div>
                  ...
                  <tbody class="row_position">
                    ...
                    <div class="form-check">
                        ...
                        <td width="150">
                          ...
                          <a href="{{url('powerup/industries-edit',$testimonial->id)}}" class="btn btn-sm btn-dark float-left mr-2"  title="Edit Industries"><i class="far fa-edit"></i></a>
                           <button class="btn btn-sm btn-danger del-modal float-left"  title="Delete Industries"  data-id="{{url('powerup/industries-delete')}}/{{ $testimonial->id}}" data-title="{{ $testimonial->title}}"  data-toggle="modal" data-target="#modal-default"><i class="fas fa-trash-alt"></i>
                          </button>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Delete Industries</h4>
            ...
            <label>Title</label>
            <h5 class="modal-title delete-title">Delete Industries</h5>
            </div>
