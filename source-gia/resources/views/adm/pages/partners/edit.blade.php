          ...
          <div class="card-body">
            ...
            <div class="col-md-12">
              <form enctype="multipart/form-data" method="post" class="form-horizontal"  
                ...
                <div class="row">
                  <div class="col-sm-4">
                    <label for="title">Edit Partners Title</label>
                    <input type="text" class="form-control" name="title" placeholder="Partners Title" value="@if(old('title')){{old('title')}}@else{{$blog->title}}@endif" required>
                    <span class="text-danger">@error('title') {{$message}} @enderror</span>
                  </div>
                  <div class="col-sm-4">
                    <label for="title">Edit Partners Short Description</label>
                    <input type="text" class="form-control" name="short_description" placeholder="Partners Short Description" value="@if(old('short_description')){{old('short_description')}}@else{{$blog->short_description}}@endif" required>     
                    <span class="text-danger">@error('short_description') {{$message}} @enderror</span>
                  </div>
                  <div class="col-sm-4">
                    <label for="title">Edit Partners Page Url</label>
                ...
                <div class="form-group row mt-3">
                  <div class="col-sm-6 col-md-6">
                    <div class="col-sm-12">
                      <label for="image_alt">Edit Partners Image</label><br>
                      ...
                      @else
                          <img class="elevation-2 perview-img mt-3"  height="120"
                    ...
                    <div class="col-sm-12 row">
                      <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control" name="image_alt"  placeholder="Partners Image Alter Text (SEO)"  value="@if(old('image_alt')){{old('image_alt')}}@else{{$blog->image_alt}}@endif">
                        <span class="text-danger">@error('image_alt') {{$message}} @enderror</span>
                      </div>
                      <div class="col-sm-6">
                        <label for="image_title">Image Title</label>
                        <input type="text" class="form-control" name="image_title" placeholder="Partners Image Title (SEO)" value="@if(old('image_title')){{old('image_title')}}@else{{$blog->image_title}}@endif">
