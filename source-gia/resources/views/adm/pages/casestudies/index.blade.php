                  ...
                  <tbody class="row_position">
                    ...
                    <div class="form-check">
                        ...
                        <td width="150">
                          ...
                          <a href="{{route('casestudies.edit',$testimonial->id)}}" class="btn btn-sm btn-dark float-left mr-2"  title="Edit CaseStudies"><i class="far fa-edit"></i></a>
                           <button class="btn btn-sm btn-danger del-modal float-left"  title="Delete CaseStudies"  data-id="{{route('admin.index')}}/casestudies/{{ $testimonial->id}}" data-title="{{ $testimonial->title}}"  data-toggle="modal" data-target="#modal-default"><i class="fas fa-trash-alt"></i>
                          </button>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Delete CaseStudies</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
            <label>CaseStudies Name</label>
            <h5 class="modal-title delete-title">Delete CaseStudies</h5>
            </div>
