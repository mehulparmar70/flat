...
<div class="gray_blk">
  ...
  <div class="gray_item">
    ...
    <span class="social-icon">
      ...
      <a href="{{getSocialMedia()->youtube}}"><img src="{{url('sardar')}}/images/youtube.png" alt="YouTube" /></a>
      @endif
      @if(isset(getSocialMedia()->linkedin))
      <a href="{{getSocialMedia()->linkedin}}"><img src="{{url('sardar')}}/images/pip.png" alt="Linkedin" /></a>
      @endif
      @if(isset(getSocialMedia()->twitter))
      <a href="{{getSocialMedia()->twitter}}"><img src="{{url('sardar')}}/images/twitter.png" alt="Twitter" /></a>
      @endif
      @if(isset(getSocialMedia()->facebook))
      <a href="{{getSocialMedia()->facebook}}"><img src="{{url('sardar')}}/images/fb.png"alt="Faceebook"/></a>
      @endif
    </span> 
  </div>
  <div class="gray_item">
