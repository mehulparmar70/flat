<div class="client_wrap">
  <div class="big_text mid_text">
    ...
    <div class="title-crud fontSize" @if(session('LoggedUser')) data-create="{{route('newsletter.index')}}" data-delete="{{route('newsletter.index')}}" data-link="{{route('newsletter.index')}}" @endif></div>
  </div>
