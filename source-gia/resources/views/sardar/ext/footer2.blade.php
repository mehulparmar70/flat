			...
			<div class="col-12">
				...
				<div class="many_partition">
					...
					>
						...
						<a href="https://www.google.com/maps/place/Giant+Inflatables+Asia/@22.2862297,73.128362,20.38z/data=!4m5!3m4!1s0x0:0x911551eaf654eefb!8m2!3d22.2861971!4d73.1283451">
							<img src="{{asset('sardar')}}/img/gia-map.png" >
						</a>
										...
										<div class="inflatables">
											...
											<div class="img_thumbnail footer_image m-auto video_thumbnail onscreen_media_video_item"
												@if(session('LoggedUser'))
													...
													data-delete-link="{{route('admin.index')}}/video/delete/{{ $footerVideo->id}}"
												@endif
		...
		<div class="container-fluid">
			<div class="col-12 p-0 px-lg-3">
				...
				<div class="bootomExploreNowslider">
					...
					<div class="bootomexplore-slide">
						<div class="bootomex_inner">
							<div class="bootomhead-slide footer_page_link_information1"
					...
					<div class="bootomexplore-slide">
						<div class="bootomex_inner">
							<div class="bootomhead-slide footer_page_blog_information1" 
								@if(session('LoggedUser'))
						...
						<div class="bootomex_inner">
							...
							@foreach(getFooterLinks()['testimonialLinks'] as $testimonialLink)
								...
								@if(isset($testimonialLink))
									<li>
									<a href="{{url('testimonials')}}?testimonial={{$testimonialLink->id}}">
										@if(isset($testimonialLink->display_name))
												{{$testimonialLink->display_name}}
											@else
											{{$testimonialLink->short_description}}
											@endif</a>
										</li>
									@endif
