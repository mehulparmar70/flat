...
@else
  <meta itemprop="image" content="{{asset('sardar')}}/img/{{getWebsiteOptions()['website_logo']->option_value}}">
@endif
...
@else
  <meta property="og:image" content="{{asset('sardar')}}/img/{{getWebsiteOptions()['website_logo']->option_value}}" />
@endif
...
@endif
  ...
  <link rel="shortcut icon" href="{{asset('sardar')}}/img/{{getWebsiteOptions()['website_favicon']->option_value}}" type="image/x-icon">
    <!-- <link rel="stylesheet" href="{{asset('sardar')}}/css/bootstrap.css"> -->
    <link rel="stylesheet"href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"/> 
    <!-- <link rel="stylesheet"href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css"/> -->
    <link rel="stylesheet" href="{{asset('sardar')}}/front/css/style.css">
    <link rel="stylesheet" href="{{asset('sardar')}}/front/css/responsive.css">
    <!-- <link rel="stylesheet" href="{{asset('sardar')}}/front/css/slick.css"> -->
    <link rel="stylesheet" href="{{asset('sardar')}}/front/css/slick.css">
    <link rel="stylesheet" href="{{asset('sardar')}}/front/css/slick-theme.css">
    <link rel="stylesheet" href="{{asset('sardar')}}/front/fonts/fonts.css">
    <link rel="stylesheet" href="{{asset('sardar')}}/front/css/fancybox.css">
