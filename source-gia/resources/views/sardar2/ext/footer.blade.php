			...
			<div class="col-12">
				<div class="notinflatables_slider footer_slider">
					<div class="inflatables my_footer_slider">
						...
						<div class="top-buttons mb-1 infa_bg title_bg_lg footer_title d-flex align-items-center onscreen_media_testimonial_title"
...
<!-- 
                                    ...
                                    src="http://localhost:8000/sardar/img/border/611X529-1.png"> -->
							...
							<div class="Innerinflatables_slider  mb-3">
									@foreach(getDataObjects('blogs', 2 ,'ASC') as $footerBlog)
										<div class="inflatables">
											...
											<div class="img_thumbnail m-auto footer_image onscreen_media_blog_item" 
			...
			<div class="col-12 p-0">
				...
				<div class="px-5 ExploreNowslider"  style="background: white;">
					@foreach(getMainCategories() as $getMainCategory)
						<div class="explore-slide" @if(session('LoggedUser')) style="width: 257px;padding-top: 37px;" @endif>
							<div class="ex_inner">
