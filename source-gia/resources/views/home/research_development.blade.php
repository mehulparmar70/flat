...
@section('title','Manufacturing - WELCOME TO CCPL WORLD An ISO 9001 : 2008 certified company')
@section('content')
@section('breadcrumb-name', 'Research & Development')
@section('breadcrumb-title', 'Research & Development')
...
<div class="row align-items-center col-mb-50">
	...
	<div class="feature-box media-box">
			<div class="fbox-media">
				<img src="{{url('home')}}/images/ccpl/injection-m1.png" alt="Why choose Us?">
			</div>
		</div>
	</div>
	...
	<div class="col-md-7 text-center text-md-start">
		...
		<p>We are a group of techno-commercial people having vast experience in the field of manufacturing and international commerce (Exports & Imports) with a team consisting of engineers, pharmacists, science graduates, and commerce graduates, skilled & experienced employees. Manufacturing facility consists of well-designed hygienic plant, effective infrastructure and Eco friendly work environment with all the necessary machinery, required technicians & knowledge to produce & procure internationally acceptable quality & packaging requirements.</p>

		<p>It also consists of all types of amenities available within factory premises, such as research & development set up, testing laboratory, computerized administrative offices with latest communication facilities and transportation.</p>
			...
			<div class="content-wrap">
					...
					<div class="row col-mb-50">
						...
						<div class="col-md-4">
							<div class="feature-box media-box flex-column">
								<div class="fbox-media">
									<img src="{{url('home')}}/images/services/2.jpg" alt="Why choose Us?">
								</div>
								<div class="fbox-content px-0">
						...
						<div class="col-md-4">
							<div class="feature-box media-box flex-column">
								<div class="fbox-media">
									<img src="{{url('home')}}/images/services/3.jpg" alt="Why choose Us?">
								</div>
								<div class="fbox-content px-0">
				...
				<div class="section">
					<div class="container">
						...
						<div class="row col-mb-50">
							<div class="col-12">
								<img data-animate="fadeIn" class="aligncenter" src="{{url('home')}}/images/services/macbook.png" alt="Macbook">
							</div>
				...
				<a href="#" class="button button-full center text-end topmargin-lg footer-stick">
					<div class="container clearfix">
