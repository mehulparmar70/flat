							...
							<div class="row col-mb-50">
								<div class="col-md-4">
									...
									<div class="widget clearfix">
										...
										<img src="{{url('home')}}/images/ccpl/ccpl-logo.png" alt="CCPL LOGO" class="footer-logo"style="width: 100px;">

										<div style="background: url('{{url('home')}}/images/world-map.png') no-repeat center center; background-size: 100%;">
											<address>
