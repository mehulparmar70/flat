...
$( ".row_position" ).sortable({
  ...
  $.ajax({
      url:"{{url('api')}}/admin/criteria/update-status",
      type:'post',
      data:{position:data},
    ...
    <section class="content-header">
      ...
      <div class="col-sm-6">
            <ol class="breadcrumb ">
              ...
              <li class="breadcrumb-item active">Edit Criteria</li>
            </ol>
          </div>
          ...
          <div class="card-body">
            ...
            <div class="col-md-4 card card-info">
              ...
              <form method="post" enctype="multipart/form-data"  class="form-horizontal"
               action="{{route('criteria.update', $criteria->id)}}">
                @csrf
                @method('PUT')
                  ...
                  <div class="form-group row">
                    ...
                    <input type="hidden" class="form-control">
                      ...
                      <input type="text" class="form-control" name="title"
                         placeholder="Criteria Title" required 
                         value="@if(old('title')){{old('title')}}@else{{$criteria->title}}@endif">
                  ...
                  <div class="form-group row">
                    <div class="col-sm-12">
                      <input type="slug" class="form-control" name="slug"
                         placeholder="Criteria Slug" 
                         value="@if(old('slug')){{old('slug')}}@else{{$criteria->slug}}@endif">
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-info">Save Criteria</button>
                </div>
              </form>
            </div>
