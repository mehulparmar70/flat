...
<?php
  $productDetail = DB::table('products')->where('category_id', $seach_id)->first();
            ...
            <div class="col-md-12"  style="
                ...
                <div class="form-group row">
                  <form action=""  class="col-sm-12 row">
                      <div class="col-sm-4">
                      <select class="form-control category_parent_id" required>
          ...
          @if(isset($seach_id))
            ...
            <form enctype="multipart/form-data" method="post" class="col-md-12"  
              ...
              @csrf
                ...
                <div class="col-sm-6">
                    <div class="col-sm-12">
                  <h5 class="text-danger pr-4 col-sm-12 mt-3">SEO CONTENTS</h5>
