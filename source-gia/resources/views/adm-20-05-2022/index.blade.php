    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="card">
          ...
          <div class="col-4 col-sm-3 col-md-2">
            <a href="{{route('criteria.index')}}" class="text-dark">
            <div class="info-box mb-3">
              <span class="info-box-icon bg-dark elevation-1"><i class="fas fa-shopping-cart"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">ADD CRITERIA</span>
              </div>
            </div>
            </a>
          </div>
...
<!--           
          <div class="col">
          <a href="{{route('admin.topInflatable.create')}}" style="color:#932ab6;background:#932ab6">
            <div class="info-box mb-3">
              <span class="info-box-icon elevation-1" 
              style="background:#932ab6"><i class="fa fa-star text-light"></i></span>

              <div class="info-box-content">
                <span class="info-box-text" >TOP INFLATABLES</span>
              </div>
            </div>
          </a>
          </div> -->
