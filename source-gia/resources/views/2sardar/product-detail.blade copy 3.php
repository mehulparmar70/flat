	...
	<section class="collection-slider bg-white product-internal-slider">
		<div class="container-fluid">
			<div class="col-12 p-0 px-md-3">
               ...
               <div class="gallery-container justified-gallery mb-4" id="animated-thumbnails-gallery">
                 
			   @foreach($productImages as $productImage)
                  <a 
        			data-lg-size="1280-720" class="gallery-item jg-entry jg-entry-visible"
				   data-src="{{url('web')}}/media/lg/{{$productImage->image}}" 
				   style="width: 162px; height: 242.966px; top: 1536.49px; left: 5px; width: 50%;"
				   data-lg-id="7f521bfe-413f-4360-9092-828816a19f69">
                  <img class="img-responsive" 
				  src="{{url('web')}}/media/lg/{{$productImage->image}}" style="width: 162px; height: 243px; margin-left: -81px; margin-top: -121.5px;">
                  </a>
				@endforeach
				...
				<div class="container-sm">
					<div class="row justify-content-center">
						...
						<div class="gallery-container justified-gallery"
							...
							@foreach($productImages as $productImage)
								...
								data-src="{{url('web')}}/media/lg/{{$productImage->image}}">
									...
									style="width: 506px; height: 338px; margin-left: -253px; margin-top: -169px;">
								</a>
							@endforeach
						</div>
				...
				<!-- <div class="BigInnerinflatableSub_slider mb-3"  id="animated-thumbnails-gallery"> 
