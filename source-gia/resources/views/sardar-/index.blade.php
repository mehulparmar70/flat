...
<div data-ride="carousel">
    ...
    <section class="collection-slider bg-white mb-5 mt-1">
        <div class="container-fluid">
            <div class="col-12">
                <div class="header-t">
					<h1><a  class="text-red" href="{{route('products')}}">ALL INFLATABLES</a></h1>
    ...
    <section class="about_giant">
        <div class="container-fluid">
            <div class="col-12">

                <div class="header-t my-3">
