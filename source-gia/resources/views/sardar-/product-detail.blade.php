...
<section class="clickANDexplore bg-white pb-0">
	...
	<section class="collection-slider bg-white product-internal-slider mt-2">
		<div class="container-fluid">
			<div class="col-12 p-0 px-md-3">
				...
				<div class="col-12">
					<div class="row">
						...
						<div class="col-md-12  internal_block col-lg-12 pr-md-0 set_max_80 my_slider_block" style="overflow: hidden;">
