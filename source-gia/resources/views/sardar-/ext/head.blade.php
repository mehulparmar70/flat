...
<link rel="preload" as="image" href="{{url('sardar')}}/img/border/100X40.png"/>
	<link rel="preload" as="image" href="{{url('sardar')}}/img/border/160X40.png"/>
	<link rel="preload" as="image" href="{{url('sardar')}}/img/border/140X40.png"/>


	<link rel="preload" as="image" href="{{url('sardar')}}/img/border/product_title_border/339X55_wh.jpg"/>
	<link rel="preload" as="image" href="{{url('sardar')}}/img/border/product_title_border/339X55_bk.jpg"/>

	<link rel="preload" as="image" href="{{url('sardar')}}/img/border/product_image_main/369X321.png"/>
	<link rel="preload" as="image" href="{{url('sardar')}}/img/border/product_title_border/262X55_wh.jpg"/>

	<link rel="preload" as="image" href="{{url('sardar')}}/img/border/product_title_border/262X55_bk.jpg"/>
	<link rel="preload" as="image" href="{{url('sardar')}}/img/border/product_title_border/320X55_bk.jpg"/>
	<link rel="preload" as="image" href="{{url('sardar')}}/img/border/product_title_border/426X55_bk.jpg"/>

	<link rel="preload" as="image" href="{{url('sardar')}}/img/border/product_image_main/369X321.png"/>
	<link rel="preload" as="image" href="{{url('sardar')}}/img/border/product_title_border/611X55_bk.jpg"/>
	<link rel="preload" as="image" href="{{url('sardar')}}/img/border/112X35_bk.png"/>
...
<link rel="stylesheet" href="{{url('website')}}/minified/css/main.css">


   <!-- Bootstrap CSS -->
    <!-- <link rel="stylesheet" href="{{url('sardar')}}/css/bootstrap.css"> -->
 <link rel="stylesheet" href="{{url('sardar')}}/css/style-sports.css">
    ...
    <link rel="stylesheet" href="{{url('sardar')}}/css/all.min.css">
  	...
  	<link rel="stylesheet" type="text/css" href="{{url('sardar')}}/css/custom-sports.css"/>
