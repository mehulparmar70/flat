...
$(document).ready(function () {
	...
	$('.sidebar-btn-handle-close').click(function (e) { 
		alert('22');
  ...
  <ul class="navbar-nav" 
		...
		<div class="top_header">
			<div class="left-aligns">  
				...
				<div class="d-none d-md-block sidebar-btn-handle" style="z-index:100;">
					<div class="search-bar">
						<i class="fa fa-bars btn-sidebar" aria-hidden="true"></i>
					</div>	
				</div>
		  ...
		  <div class="logo">
			  	...
			  	<div class="d-flex justify-content-center justify-content-around align-items-center d-md-none">
					<div class="sidebar-btn-handle pr-2" style="z-index:100;">
						<div class="search-bar">
							<i class="fa fa-bars btn-sidebar" aria-hidden="true"></i>&nbsp;&nbsp;
						</div>	
					</div>
<!-- 
					<div class="sidebar-btn-handle" style="z-index:100;">
						<div class="search-bar">
							<h1>Enquiry Now</h1>
						</div>	
					</div> -->
				...
				<div class="">    
						<a class="nav-link"><img src="{{url('sardar')}}/img/envlp.png" class="img-fluid mr-2">
						&nbsp;&nbsp;Send Us Your Enquiry</a>
				</div>  
...
@include('sardar.widget.enquire-now2')
	...
	<!-- 		
			<nav class="navbar navbar-expand-lg navbar-design p-lg-0 d-block d-md-none">
