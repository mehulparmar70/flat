...
Route::post('showimg', [HomeController::class, 'industriesImages']);
// Route::get('showimg/{id}', [HomeController::class, 'industriesImagesAjax']);
Route::get('contact-us', [HomeController::class, 'contact'])->name('contact');
Route::get('thankyou', [HomeController::class, 'thankyou'])->name('thankyou');
Route::get('destorySession', [HomeController::class, 'destorySession']);
Route::post('getCatogery', [HomeController::class, 'getCatogery']);
...
Route::group(['middleware'=> ['AuthCheck']], function(){
    ...
    Route::resource('/email-filter',EmailFilterController::class);
    ...
    Route::get('/admin/close', [CategoryController::class, 'close'])->name('admin.close');
    
    
    Route::get('/home-editor', [HomeEditorController::class, 'homeEditorIndex'])->name('admin.home.editor');
    Route::get('/industries-create', [IndustriesController::class,'create']);
    Route::post('/industries-store', [IndustriesController::class,'store']);
    Route::get('/industries-index', [IndustriesController::class,'index']);
    Route::get('/industries-edit/{id}', [IndustriesController::class,'edit']);
    Route::post('/industries-update/{id}', [IndustriesController::class,'update']);
    Route::delete('/industries-delete/{id}', [IndustriesController::class,'deleteItem']);
    Route::get('/industries/delete/{id}', [IndustriesController::class, 'deleteItem'])->name('industries.delete');
    ...
    Route::get('/testimonial/delete/{id}', [TestimonialController::class, 'deleteItem'])->name('admin.testimonial.item.delete');
    Route::get('/casestudies/delete/{id}', [CaseStudiesController::class, 'deleteItem'])->name('admin.casestudies.item.delete');
    Route::get('/newsletter/delete/{id}', [NewsletterController::class, 'deleteItem'])->name('admin.newsletter.item.delete');
    Route::get('/blog/delete/{id}', [BlogController::class, 'deleteItem'])->name('admin.blog.item.delete');
    Route::get('/video/delete/{id}', [VideoController::class, 'deleteItem'])->name('admin.video.item.delete');
    Route::get('/award/delete/{id}', [AwardController::class, 'deleteItem'])->name('admin.award.item.delete');
    ...
    Route::resources([
        ...
        '/casestudies' => CaseStudiesController::class,
...
// Tiny Png Api
Route::get('/tinypng', [TinyPngController::class, 'index'])->name('admin.tinypng');
Route::post('/tinypng', [TinyPngController::class, 'store'])->name('admin.tinypng.store');
Route::get('/media-table-webp', [TinyPngController::class, 'mediaTableCovert2Webp'])->name('admin.tinypng.mediaTableCovert2Webp');
Route::get('/webp-converter', [TinyPngController::class, 'webpConverter'])->name('tinypng.webp-converter');
...
Route::post('/search', [HomeController::class, 'search_criteria']);
